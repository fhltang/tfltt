...
// ContextValidate validate this tfl Api presentation entities instruction based on the context it is used
func (m *TflAPIPresentationEntitiesInstruction) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TflAPIPresentationEntitiesInstruction) contextValidateSteps(ctx context.Context, formats strfmt.Registry) error {
