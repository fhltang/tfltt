...
// ContextValidate validates this tfl Api presentation entities service frequency based on context it is used
func (m *TflAPIPresentationEntitiesServiceFrequency) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
